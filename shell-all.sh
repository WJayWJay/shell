...
mbedtls_file="mbedtls-2.6.1"
mbedtls_url="https://github.com/ARMmbed/mbedtls/archive/mbedtls-2.6.1.tar.gz"
...
install_mbedtls() {
    if [ ! -f /usr/lib/libmbedtls.a ]; then
        ...
        tar xf ${mbedtls_file}-gpl.tar.gz
        cd ${mbedtls_file}
...
install_shadowsocks_python() {
    ...
    python setup.py install --record /var/log/shadowsocks_python_install.log
